...
const projects = [
  ...
  // },
  {
    num: '01',
    category: 'Front End',
    title: 'Scrambe Words App',
    description: 'A fun and interactive Scramble Words Game built with React and TypeScript, using the React useReducer hook for structured state management. Players try to unscramble shuffled words, earn points for correct guesses, and progress through a dynamic word list stored in the app’s state.',
    stack: [
    ...
    image: '/assets/work/scrambe-words/image.png',
    live: 'https://adivina-la-palabra-minigame.netlify.app/',
    github: 'https://github.com/MiltonMG/Scrambe-Words-App-React-Reducer',
  },
  {
    num: '02',
    category: 'Front-End / API',
    title: 'Find a gif',
    description: 'A TypeScript-based React web application for searching and displaying GIFs, optimized with client-side caching for fast and efficient performance.',
    stack: [
      { name: 'TypeScript', color: 'blue' },
      { name: 'HTML', color: 'orange' },
      { name: 'CSS', color: 'blue' },
      { name: 'React', color: 'lightBlue' },
      { name: 'Taildwind', color: 'lightBlue' },
      { name: 'GIPHY', color: 'purple' },
    ],
    image: '/assets/work/findgif/image.png',
    live: 'https://find-gif.netlify.app/',
    github: 'https://github.com/MiltonMG/Gifs-App-Cache-React-TS',
  },
  {
    num: '03',
    category: 'Front-End',
  ...
  {
    num: '04',
    category: 'Front-End / Persistent data / Data Validation',
    title: 'Task Manager',
